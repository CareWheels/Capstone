...
describe('Controller: Group Status -', function () {
  ...
  describe('getAlertColor():', function () {
    it('check red', function () {
      ...
      $scope.group[1].status = $scope.getAlertColor(2, 2, 1);
      $scope.group[2].status = $scope.getAlertColor(2, 1, 2);
      $scope.group[3].status = $scope.getAlertColor(1, 2, 3);
      $scope.group[4].status = $scope.getAlertColor(2, 0, 4);
    ...
    it('check yellow', function () {
      ...
      // calls a function that sets the alert color
      // then assert that the status color is set to red
      $scope.group[1].status = $scope.getAlertColor(1, 0, 1);
      $scope.group[2].status = $scope.getAlertColor(0, 1, 2);
      $scope.group[3].status = $scope.getAlertColor(1, 0, 3);
      $scope.group[4].status = $scope.getAlertColor(1, 1, 4);
    ...
    it('check blue', function () {
      ...
      // calls a function that sets the alert color
      // then assert that the status color is set to red
      $scope.group[1].status = $scope.getAlertColor(0, 0, 1);
    ...
    it('check error', function () {
      ...
      // then assert that the status color is set to red
      $scope.group[1].status = $scope.getAlertColor(-1, 0, 1);
      $scope.group[2].status = $scope.getAlertColor(2, null, 2);
      $scope.group[3].status = $scope.getAlertColor(null, 1, 3);
      $scope.group[4].status = $scope.getAlertColor(2, -99999, 4);
